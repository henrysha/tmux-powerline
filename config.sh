...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/user/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/user/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/user/.now_playing.log"
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-v -a 0 -m 0"
# }
